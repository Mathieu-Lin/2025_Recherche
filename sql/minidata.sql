...
--
INSERT INTO
    `2025_attachments` (`id`, `pdf_link`, `article_link`, `video_link`)
VALUES
    (
        1,
        'https://inria.hal.science/inria-00000987/file/AntDevMon06CPE.pdf',
        'https://onlinelibrary.wiley.com/doi/abs/10.1002/cpe.1024',
        NULL
    ),
    (
        2,
        'https://pages.lip6.fr/Olivier.Marin/Publis/nossdav14.pdf',
        'https://dl.acm.org/doi/abs/10.1145/2578260.2578265',
        NULL
    ),
    (
        3,
        'https://dl.acm.org/doi/pdf/10.1145/3659944',
        'https://dl.acm.org/doi/abs/10.1145/3659944',
        NULL
    );
...
--
INSERT INTO
    `2025_publish` (`id_author`, `id_publication`)
VALUES
    (1, 1),
    (1, 2),
    (6, 2),
...
--
INSERT INTO
    `2025_quotes` (`id_publication`, `id_quote`)
VALUES
    (1, 3);
...
--
INSERT INTO
    `2025_links` (`id_publication`, `id_attachment`)
VALUES
    (1, 1),
    (2, 2),
    (3, 3);
